...
% Metrics
We measure the amount of time it takes for other devices to discover new content in a channel they are subscribed to, from the moment it was added to that channel.
% Expected / desired results
...
\begin{figure}[H]
	...
	\caption{Elapsed time from having added new content to a channel and it being discovered by subscribed peers.}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Startup time statistics per device.}
...
\begin{figure}[H]
	...
	\caption{Adding a torrent to a channel with respect to the original content size.}
