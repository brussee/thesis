...
With JMeter we request the discovered channels from the API a 1000 times at a constant rate of one request per second.
A laptop is included to give some more perspective.
Its specifications are listed in Table \ref{table:specs_laptop}.
% Results
Figures \ref{fig:api_Laptop}, \ref{fig:api_Nexus_6}, \ref{fig:api_Laptop-2} and \ref{fig:api_Nexus_6-2} show the response times for every request.
\begin{figure}[H]
	\centering
	\begin{minipage}{.49\textwidth}
	...
	\begin{minipage}{.49\textwidth}
		...
		\caption{API response times right after first launch on Nexus 6 smartphone.}
	...
	\begin{minipage}{.49\textwidth}
		...
		\caption{API response times on a Nexus 6 smartphone.}
...
\begin{table}[H]
  ...
  \end{tabular}
  \caption{Statistics of API response times from Figures \ref{fig:api_Laptop}, \ref{fig:api_Nexus_6}, \ref{fig:api_Laptop-2} and \ref{fig:api_Nexus_6-2} respectively.}
  \label{table:api_benchmark}
\end{table}
The set rate of 300 requests per minute is clearly not reached by the smartphone in our benchmark by a factor of 9.
...
The video has a bit rate of 4565 kb/s.
% Results
\begin{figure}[p]
	\centering
	\begin{minipage}{.3\textwidth}
		\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the GUI, during HD video streaming on a Galaxy S3 smartphone
...
\begin{minipage}{.3\textwidth}
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the back-end service, during HD video streaming on a Galaxy S3 smartphone
			}\end{minipage}},rotate=90,center}
...
\begin{minipage}{.3\textwidth}
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the video player VLC, during HD video streaming on a Galaxy S3 smartphone
			}\end{minipage}},rotate=90,center}
