...
\begin{figure}[ht]
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
						CPU usage snapshot while running all tests and Multichain experiment
			}\end{minipage}},rotate=90,center}
		\includegraphics[scale=0.4]{cpu_usage_2}
	\end{adjustbox}
...
\begin{figure}[ht]
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
						Creating and signing of 25.000 blocks between two peers
			}\end{minipage}},rotate=90,center}
		\includegraphics[scale=0.4]{multichain_scale_2599_25k}
	\end{adjustbox}
