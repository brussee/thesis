...
%TODO grote scenario
% Rationale
New content can be generated with a smart-phone, like for example a video that has been recorded with the builtin camera.
...
% Setup
A Nexus 6 smart-phone with Android 7.1 CyanogenMod is connected to a laptop running JMeter and the API port is forwarded with ADB over USB.
...
\begin{figure}[p]
	...
	\begin{minipage}{.3\textwidth}
		\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the GUI, during HD video streaming on a Galaxy S3 smart-phone
...
\begin{minipage}{.3\textwidth}
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the back-end service, during HD video streaming on a Galaxy S3 smart-phone
			}\end{minipage}},rotate=90,center}
...
\begin{minipage}{.3\textwidth}
	\begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{
							CPU usage of the video player VLC, during HD video streaming on a Galaxy S3 smart-phone
			}\end{minipage}},rotate=90,center}
